        ...
        <div className='flex flex-col items-center justify-between xl:pt-8 xl:pb-24'>
          ...
          <div className='text-center xl:text-center intro'>
            ...
            <p className='max-w-[600px] mb-9 text-white/80'>
              I am a software developer with years of experience in creating innovative solutions. A fast learner with a passion for continuous improvement, I thrive on new challenges and am eager to expand my skill set.
            </p>
            {/* btn & socials */}
